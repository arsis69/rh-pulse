          ...
          <div className="overflow-hidden rounded-3xl border border-edge bg-surface">
            <div className="grid gap-10 p-8 sm:p-12 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mt-3 text-[28px] font-bold leading-tight tracking-tight sm:text-[34px]">
                  $PULSE is the engine for Pulse app
                </h2>
                <p className="mt-5 text-[15.5px] leading-[1.7] text-ink-2">
                  Pulse is a free app. There are no premium tiers, no paywalled feeds, and no locked features. Every fee
                  generated by trading $PULSE goes straight back into making the app better.
                </p>
                <ul className="mt-6 space-y-3">
                  {[
                    'Smarter AI models that score tokens faster and more accurately',
                    'More data sources, launchpads, and on-chain signals',
                    'Faster infrastructure so the feed stays realtime under load',
                    'New features and tools that surface the next move before the crowd',
                    'Expansion to more chains as attention moves',
                  ].map((t) => (
              ...
              <div className="flex flex-col justify-center rounded-2xl border border-edge bg-surface-2 p-6">
                ...
                <p className="mt-3 text-[14.5px] leading-[1.7] text-ink-2">
                  Every $PULSE trade carries a 1% fee. The Pulse share is reinvested entirely into the improvements above
                  — better AI, more data, faster infrastructure, more chains, and a fuller app. It never goes to hiding
